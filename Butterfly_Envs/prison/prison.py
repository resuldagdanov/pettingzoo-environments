...
def create_env(args, is_parallel):
    if is_parallel:
        env = prison_v3.parallel_env(vector_observation=False, continuous=False, synchronized_start=False,
...
if __name__ == "__main__":
    ...
    algo_name = "PPO"
    env_name = "prison_v3"
    checkpoint_path = "/home/resul/ray_results/PPO_prison_v3_2021-09-14_16-21-56xwv3w1v2/checkpoint_000001/checkpoint-1"
    params_path = "/home/resul/ray_results/PPO_prison_v3_2021-09-14_16-21-56xwv3w1v2/params.pkl"
    ...
    # training
        ...
        # define how many episodes to be trained
        for _ in range(100):
            trainer.train()
